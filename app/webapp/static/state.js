...
export const els = {
  ...
  lifeOsConvoSearch: document.getElementById('lifeOsConvoSearch'),
  lifeOsConvos: document.getElementById('lifeOsConvos'),
  ...
  claudeFilterInput: document.getElementById('claudeFilterInput'),
